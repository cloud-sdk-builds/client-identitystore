...
[`@aws-sdk/client-identitystore`](https://www.npmjs.com/package/@aws-sdk/client-identitystore/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-identitystore@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MizjCFuJDcjsaHtLujSGoruz+INnxi9d/EUp44DCPbSpRENVGxHSrc4ZFPr25vYM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-identitystore": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-identitystore@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-identitystore@3.967.0/index.min.mjs": "sha384-MizjCFuJDcjsaHtLujSGoruz+INnxi9d/EUp44DCPbSpRENVGxHSrc4ZFPr25vYM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-identitystore/blob/refs/tags/3.967.0/LICENSE
```
